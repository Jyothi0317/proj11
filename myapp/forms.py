...
class SampleForm(forms.Form):
    first_name=forms.CharField( max_length=20, required=True,label="First Name", widget=forms.TextInput(attrs={'placeholder':"enter first name"}))
    last_name=forms.CharField( max_length=20, required=False,label="Last Name",widget=forms.TextInput(attrs={'placeholder':"enter last name"}))
    email=forms.EmailField(max_length=100, required=True,label="Email",widget=forms.TextInput(attrs={'placeholder':"enter email"}))
    ...
    languages=forms.MultipleChoiceField(choices=[('kannada','kannada'),('english','english'),('hindi','hindi')],widget=forms.CheckboxSelectMultiple)